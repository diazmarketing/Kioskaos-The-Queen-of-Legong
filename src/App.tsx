        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-6 md:gap-10">
            ...
            >
              {/* Gambar produk depan */}
              <img 
                src="/foto-depan-1.png?v=2" 
                alt="Tampilan Depan" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return; // Avoid infinite loop
                  target.src = 'https://i.postimg.cc/8cVk6jH8/foto-depan-1.png';
                }}
            ...
            >
              ...
              <img 
                src="/foto-belakang-1.png?v=2" 
                alt="Tampilan Belakang" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return;
                  target.src = 'https://i.postimg.cc/hPZYhNMD/foto-belakang-1.png';
                }}
                className="w-full h-full object-cover relative z-10 group-hover:scale-105 transition-transform duration-1000 transform-gpu"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-80 md:opacity-70 transform-gpu"></div>
            ...
            >
              <img 
                src="/foto-depan-2.png?v=2" 
                alt="Tampilan Depan" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return;
                  target.src = 'https://i.postimg.cc/K8J8KGwq/foto-depan-2.png';
                }}
                className="w-full h-full object-cover relative z-10 group-hover:scale-105 transition-transform duration-1000 transform-gpu"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-80 md:opacity-70 transform-gpu"></div>
            ...
            >
              <img 
                src="/foto-belakang-2.png?v=2" 
                alt="Tampilan Belakang" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return;
                  target.src = 'https://i.postimg.cc/hPZYhNMK/foto-belakang-2.png';
                }}
                className="w-full h-full object-cover relative z-10 group-hover:scale-105 transition-transform duration-1000 transform-gpu"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-80 md:opacity-70 transform-gpu"></div>
            ...
            >
              <img 
                src="/foto-depan-3.jpg?v=2" 
                alt="Tampilan Depan" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return;
                  target.src = 'https://i.postimg.cc/0NwFTZYK/99688bc3-7dab-47a8-954b-14b076bfc8a0.jpg';
                }}
                className="w-full h-full object-cover relative z-10 group-hover:scale-105 transition-transform duration-1000 transform-gpu"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-80 md:opacity-70 transform-gpu"></div>
            ...
            >
              <img 
                src="/foto-belakang-3.jpg?v=2" 
                alt="Tampilan Belakang" 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  if (target.src.includes('postimg')) return;
                  target.src = 'https://i.postimg.cc/ZKsQ0XjS/foto-belakang-3.jpg';
                }}
                className="w-full h-full object-cover relative z-10 group-hover:scale-105 transition-transform duration-1000 transform-gpu"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-80 md:opacity-70 transform-gpu"></div>
          ...
          <div className="flex flex-col items-end gap-3 text-right">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://www.instagram.com/kioskaosbalinesia.ofc/" target="_blank" rel="noreferrer" className="text-[8.5px] md:text-[10px] tracking-[1px] md:tracking-[2px] text-[#E5E5E5]/40 hover:text-[#C5A059] transition-all flex items-center justify-start group w-full">
                <img src="/Instagram-logo.png?v=2" alt="Instagram" className="w-[12px] h-[12px] md:w-[14px] md:h-[14px] mr-3 opacity-30 group-hover:opacity-100 group-hover:brightness-0 group-hover:invert-[.6] group-hover:sepia-[.6] group-hover:saturate-[5] group-hover:hue-rotate-[10deg] transition-all duration-300 object-contain" />
              ...
              <a href="https://www.facebook.com/profile.php?id=61552872545508" target="_blank" rel="noreferrer" className="text-[8.5px] md:text-[10px] tracking-[1px] md:tracking-[2px] text-[#E5E5E5]/40 hover:text-[#C5A059] transition-all flex items-center justify-start group w-full">
                <img src="/Facebook-logo.png?v=2" alt="Facebook" className="w-[12px] h-[12px] md:w-[14px] md:h-[14px] mr-3 opacity-30 group-hover:opacity-100 group-hover:brightness-0 group-hover:invert-[.6] group-hover:sepia-[.6] group-hover:saturate-[5] group-hover:hue-rotate-[10deg] transition-all duration-300 object-contain" />
                <span className="w-[110px] sm:w-[160px] md:w-[180px] text-left leading-none tracking-[1px] md:tracking-[2px]"><span className="hidden sm:inline">kioskaosbalinesia.ofc</span><span className="sm:hidden">kioskaos</span></span>
              </a>
              ...
              <a href="https://www.tiktok.com/@kioskaosbalinesia.ofc" target="_blank" rel="noreferrer" className="text-[8.5px] md:text-[10px] tracking-[1px] md:tracking-[2px] text-[#E5E5E5]/40 hover:text-[#C5A059] transition-all flex items-center justify-start group w-full">
                <img src="/tiktok-logo.png?v=2" alt="TikTok" className="w-[12px] h-[12px] md:w-[14px] md:h-[14px] mr-3 opacity-30 group-hover:opacity-100 group-hover:brightness-0 group-hover:invert-[.6] group-hover:sepia-[.6] group-hover:saturate-[5] group-hover:hue-rotate-[10deg] transition-all duration-300 object-contain" />
                <span className="w-[110px] sm:w-[160px] md:w-[180px] text-left leading-none tracking-[1px] md:tracking-[2px]"><span className="hidden sm:inline">kioskaosbalinesia.ofc</span><span className="sm:hidden">@kioskaos</span></span>
              </a>
            </div>
          </div>
